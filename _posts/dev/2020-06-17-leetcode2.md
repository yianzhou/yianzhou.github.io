...
考虑到 1->1->1->2->3->4->NULL 这种边界情况，有可能头部结点要被删除，因此本题显然是需要 dummy 指针的。

先讲思路，我们用一前一后两个指针 a、b，如果节点 a 的值不等于结点 b 的值，那么指针 a、b 都向前移动一位。

反之，a 不动、b 向前移动，直到遇到一个与节点 a 不相等的值，中间重复的结点全部舍弃，然后用 next 指针连接起来即可！
...
## [912-数组排序](https://leetcode-cn.com/problems/sort-an-array/)
