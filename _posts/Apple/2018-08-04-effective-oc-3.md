...
```
Another method to be aware of is ``debugDescription``, called when you invoke the *print-object* command within the debugger. The default implementation within the NSObject class simply calls directly through to description.
