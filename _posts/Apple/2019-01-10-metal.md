...
> [Devices and Commands: Demonstrates how to access and interact with the GPU.](https://developer.apple.com/documentation/metal/devices_and_commands)
...
> [Hello Triangle: Demonstrates how to render a simple 2D triangle.](https://developer.apple.com/documentation/metal/hello_triangle)
...
# Texture
A key feature of any graphics technology is the ability to process and draw images. Metal supports this feature in the form of textures that contain image data. Unlike regular 2D images, textures can be used in more creative ways and applied to more surface types.
