...
安装 [zsh-autosuggestions](https://github.com/zsh-users/zsh-autosuggestions/blob/master/INSTALL.md)，按右键接受建议

<!-- 修改主题：`ZSH_THEME="agnoster"` -->

<!-- 安装字体：[Powerline fonts](https://github.com/powerline/fonts) -->

<!-- 修改字体：iTerm -> Preferences -> Profiles -> Text -> Font -->
