...
sequenceDiagram
    ...
    participant RCTJavaScriptLoader
...
sequenceDiagram
    participant RCTCxxBridge
    participant RCTMessageThread.mm
    RCTCxxBridge->>JSExecutorFactory: make_shared
    RCTCxxBridge->>RCTCxxBridge: _initializeBridge:
    RCTCxxBridge->>RCTMessageThread.mm: make_shared
    RCTCxxBridge->>RCTCxxBridge: _initializeBridgeLocked:
    RCTCxxBridge->>Instance.cpp: initializeBridge
    Instance.cpp->>NativeToJsBridge.cpp: make_shared
    NativeToJsBridge.cpp->>JSExecutorFactory: createJSExecutor
    JSExecutorFactory->>JSIExecutor: make_unique
    Instance.cpp->>NativeToJsBridge.cpp: initializeRuntime
</div>
<!-- markdownlint-restore -->
