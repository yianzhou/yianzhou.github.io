...
有一个开源库是做这个的：<https://github.com/steipete/Aspects>
...
会触发离屏渲染的效果，以上效果在同等数量的规模下，对性能的影响等级：Shadow > RoundedCorner > Mask > GroupOpacity。

Xcode 的 Core Animation Instruments 里使用 Color Offscreen-Renderd Yellow 选项可以检测离屏渲染。
